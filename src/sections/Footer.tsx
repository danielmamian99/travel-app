        ...
        <div className="flex justify-center mt-8">
          <figure className="flex justify-center items-center border-r-2 border-[#FF694C] w-1/2 md:w-1/3">
            <img
              ...
              srcSet="/images/footer/titulos/titulo.png 480w, /images/footer/titulos/titulo2.png 768w, /images/footer/titulos/titulo3.png 1280w"
          ...
          <div className="flex justify-center w-1/2">
            <figure className="mt-8 w-64 md:w-80">
              <img
                ...
                srcSet="/images/footer/reservas/reserva.png 480w, /images/footer/reservas/reserva2.png 768w, /images/footer/reservas/reserva3.png 1280w"
                sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, 1280px"
          ...
          <div className="flex flex-col justify-center items-center w-1/2">
            ...
            <figure className="flex justify-center lg:w-10/12">
              <img
                ...
                srcSet="/images/footer/acotur/acotur.png 480w, /images/footer/acotur/acotur2.png 768w, /images/footer/acotur/acotur3.png 1280w"
                sizes="(max-width: 480px) 480px, (max-width: 768px) 768px, 1280px"
                alt="Acotur"
              />
            </figure>
